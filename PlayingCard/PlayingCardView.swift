...
//  PlayingCard
//
//  Created by spongebink on 2019/1/30.
...
@IBDesignable class PlayingCardView: UIView {
    ...
    */
    ...
    @objc func adjustfFaceCardScale(byHandelingGestureReconizerBy reconizer: UIPinchGestureRecognizer) {
        switch reconizer.state {
        case .changed, .ended: faceCardScale *= reconizer.scale
            reconizer.scale = 1.0
        default: break
        }
    }
...
//            context.addArc(center: CGPoint(x: bounds.midX, y: bounds.midY), radius: 100.0, startAngle: 0, endAngle: CGFloat.pi, clockwise: true)
...
//        path.addArc(withCenter: CGPoint(x: bounds.midX, y: bounds.midY), radius: 100.0, startAngle: 0, endAngle: CGFloat.pi, clockwise: true)
//        path.lineWidth = 5.0
//        UIColor.green.setFill()
//        UIColor.red.setStroke()
//        path.stroke()
